...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($voltage === null || $current === null || $power === null || $power_factor === null) {
        echo json_encode(['status' => 'error', 'message' => 'Missing required fields']);
        exit;
    }

    $stmt = $pdo->prepare("INSERT INTO readings (voltage, current, power, power_factor) VALUES (?, ?, ?, ?)");
    $stmt->execute([$voltage, $current, $power, $power_factor]);
